...
#Gff file
GFF = "C:/Users/User/Documents/BioAtallah/RepeatMasker/RepeatOpp/Dmel_Only/Dmel_Data/DROSOPHILA_MELANOGASTER_final.gff"
...
with open("Filter_DMel.gff", "w", encoding="utf-8") as out:
    for row in stripGFF:
          out.write(row)